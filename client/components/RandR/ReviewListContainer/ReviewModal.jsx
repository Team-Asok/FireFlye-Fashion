...
class ReviewModal extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    const summary = `${review.substring(0, 60)}...`;
  ...
  minCharacterLength = () => {
    ...
    return <div id="characters-until-50">Minimum achieved</div>;
  };
  ...
  starRatingGraphic() {
    return (
      <StarGraphic
        metaScore={this.state.rating}
        onClick={this.handleStarRatingGraphicClick.bind(this)}
      />
    );
  }
  ...
  renderFactors() {
    ...
    const characteristicsArray = Object.entries(
      this.props.metaData.characteristics
    );
      ...
      return (
        <div key={`${index}`}>
          ...
          >
            {" "}
            {characteristic[0]}: <br />
            <label htmlFor={`${characteristic[1].id}1`}>
              {characteristicsGuide[characteristic[0]][0]}
            </label>
            <input
              onChange={this.handleRadioSelect}
              type="radio"
              id={`${characteristic[1].id}1`}
              name={characteristic[0]}
              value="1"
            />
            <label htmlFor={`${characteristic[1].id}2`}>
              {characteristicsGuide[characteristic[0]][1]}
            </label>
            <input
              onChange={this.handleRadioSelect}
              type="radio"
              id={`${characteristic[1].id}2`}
              name={characteristic[0]}
              value="2"
            />
            <label htmlFor={`${characteristic[1].id}3`}>
              {characteristicsGuide[characteristic[0]][2]}
            </label>
            <input
              onChange={this.handleRadioSelect}
              type="radio"
              id={`${characteristic[1].id}3`}
              name={characteristic[0]}
              value="3"
            />
            <label htmlFor={`${characteristic[1].id}4`}>
              {characteristicsGuide[characteristic[0]][3]}
            </label>
            <input
              onChange={this.handleRadioSelect}
              type="radio"
              id={`${characteristic[1].id}4`}
              name={characteristic[0]}
              value="4"
            />
            <label htmlFor={`${characteristic[1].id}5`}>
              {characteristicsGuide[characteristic[0]][4]}
            </label>
            <input
              onChange={this.handleRadioSelect}
              type="radio"
              id={`${characteristic[1].id}5`}
              name={characteristic[0]}
              value="5"
            />
          </div>
      ...
      <div className="modal">
        <div className="modal-content">
          <div className="model-header">
            ...
            <div>{this.starRatingGraphic()}</div>
          </div>
          <div className="modal-body">
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="modal-recommended">
                ...
                <input
                  onChange={this.handleRecommendSelect}
                  type="radio"
                  id="yes"
                  name="recommend"
                  value
              ...
              <div className="factors">{this.renderFactors()}</div>
